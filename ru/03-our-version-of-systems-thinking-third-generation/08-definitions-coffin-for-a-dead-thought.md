...
Мы не будем давать поводов путаться в «определениях», а потом
...
При объяснении незнакомых понятий через другие незнакомые понятия
...
Системное мышление --- про жизнь, это не математика, где у точек нет
