...
Если выход за пределы «работы как ролевой игры» очевиден, то есть вы
...
добавить к результатам проекта что-то такое, что могут добавить только
...
форме документировать архитектурные решения (не диаграммами, а ADR,
